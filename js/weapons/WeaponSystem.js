...
export class WeaponSystem{
  ...
  reload(){const w=this.config;if(w.melee||this.reloadLeft>0||this.ammo>=w.mag||this.reserve<=0)return false;this.reloadLeft=w.reload;return true}
